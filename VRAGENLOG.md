...
## TD-antwoordenronde Maxim (2026-08-04) - verwerkt
DOORGEVOERD: (1) escape-kisten samengevoegd: kamp-Spionnen-curvers "Ontmantel de bom"+"Moord in de V-express" nu gedeeld met TD Let''s escape, TD-duplicaten verwijderd; (2) Balanceren op een been: kamp en TD delen de 2 M00-bakken (m-gang, geen vaste plek) - kampbakken opgeheven, 14 kamp-items overgezet, TD-bakken aan beide themas; (5) Paralympics-bak K43 ook aan Sportymadness gekoppeld (verifieren); (9) Sticks&bats-pakketten ook aan kamp Slag- en balsporten; (14) sjoelbak = 1 bevestigd; (15) RGA-RGE = gelijkvloers-ruimtes (L31); (3) themaframes = 1 systeem met wisseldoeken - frames worden pool bij S4.5 (L31); (19-22) schildersezel-attribuut, superheldenpakken-in-bak, print-aannames en verzamelstroom-aannames bevestigd; (4) aparte code = aparte bak bevestigd (Sportyson/Experimenteeratelier/Groene vingers/Wereldkeuken/Zoete toetjes blijven eigen bakken); (10) Koekiemonstertjes-keukenspullen vermoedelijk uit kookbak - notitie, bij nakijk checken.
SAMEN TE BEKIJKEN (Maxim): compressors-aantal, 3x3-springkastelen + Jumpen XL-mapping, houten-blokken-kisten (2 of 3), iglo/duplo-aantallen, "We slaan er op los"/"Kriebelbeestjes" apart of samen (vraag 17: geen idee), plus punten 23-30 (Klimwereld, Sportymadness-naam, bouwtotalen, Koekiemonsters-KV, lasershoot-telling, nerf/bamboe, Reis rond de wereld 4/6-5/6, 10 potloden/kind).

### S4.5g BULK-POOL (Chat A, 2026-08-04) — twijfelgevallen NIET samengevouwen
Migratie 63 heeft enkel de expliciet opgesomde bulk-categorieën samengevouwen (kleuterfietsen, loopfietsen, loopwagens, zitfietsen, easy rollers, rolplanken+stokken, bouwhelmen, kruiwagens, verlengdraadkoffers, WESCO-pakketten, blazers [2 wattage-groepen], duplo-/softlego-/clics-bakken, compressors). De volgende reeksen genummerde vast_types zijn bewust ONGEMOEID gelaten als losse rijen — geen van beide staat expliciet in de bulk- of unieke-lijst uit de opdracht:
- **houtenblokken_koffer** ("Koffer houten blokken 1"/"2", 2 rijen): thema_behoefte (Migratie 62, Blokkenbouwdoos) gebruikt dit al met `aantal:2` alsof het bulk is, maar de opdracht noemt het nergens expliciet — is dit bulk (enkel het aantal telt) of zijn het 2 te onderscheiden fysieke koffers? Bij "bulk" bevestigen: 2→1 samenvouwen + generator-check dat de bestaande Blokkenbouwdoos-behoefte (aantal 2) nog steeds 1 regel "2 × Koffer houten blokken" oplevert (nu nog 2 losse "Bak"-regels, want de code herkent ze niet als bulk).
- **zeepkist** ("Zeepkist 1"–"4", 4 rijen, thema Zeepkistenrace): lijkt op "genummerd = bulk"-patroon, maar zeepkisten zijn fysiek waarschijnlijk individueel verschillend (bestuurbaar voertuig, geen inwisselbaar stuk zoals een fiets) — analoog aan springkastelen eerder bewust NIET als bulk behandeld. Verifiëren of dit klopt of dat het toch bulk moet worden.
- **creatool** ("Creatool OPLA (kist XL)" / "Creatool SPOK pakket", 2 rijen): verschillende namen (geen trailing nummer op dezelfde basisnaam) — voldoet sowieso niet aan het "reeks van identieke genummerde rijen"-criterium uit de opdracht, dus hoe dan ook niet samengevouwen; vermeld voor de volledigheid.
Geen van deze 3 categorieën is aangeraakt door Migratie 63 (rijen ongewijzigd); als Maxim bevestigt dat het bulk is, is dat een kleine vervolgmigratie (zelfde `_vouwSamen`-patroon, al aanwezig in de code).
